...
type Iterator[K container.Comparable[K], V any] struct {
	Key  K // unique
	Val  V
	next bool
}
...
type rbtree_node[K container.Comparable[K], V any] struct {
...
func rbt_copy_color[K container.Comparable[K], V any](n1, n2 *rbtree_node[K, V]) {
	n1.color = n2.color
}

func rbtree_min[K container.Comparable[K], V any](node *rbtree_node[K, V], sentinel *rbtree_node[K, V]) *rbtree_node[K, V] {
...
type RBTree[K container.Comparable[K], V any] struct {
	length   int
	root     *rbtree_node[K, V]
	sentinel *rbtree_node[K, V]
}

func New[K container.Comparable[K], V any]() *RBTree[K, V] {
