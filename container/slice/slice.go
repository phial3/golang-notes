...
func (this *Slice[T]) Sort(cmp func(a, b T) container.Ordering) *Slice[T] {
...
func (this *Slice[T]) Unique(cmp func(a, b T) container.Ordering) *Slice[T] {
	var n = this.Len()
	if n == 0 {
		return this
	}
	...
	results.Push((*this)[0])
	for i := 1; i < n; i++ {
		if cmp((*this)[i], (*this)[i-1]) != container.Equal {
			results.Push((*this)[i])
		}
	}
	*this = results
